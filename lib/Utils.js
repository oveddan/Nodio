...
InstrumentBroadcaster.prototype.listenForRequestsToHearInstrument = function(){
    ...
    this.ioListener.on('connection', InstrumentBroadcaster.onConnection);
};
...
InstrumentBroadcaster.prototype.sendKeyPressed = function(key, instrumentName){
    this.ioListener.sockets.in(instrumentName).emit({key : key})
}
